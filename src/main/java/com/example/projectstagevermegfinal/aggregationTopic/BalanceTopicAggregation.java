...
import com.example.projectstagevermegfinal.ProjectStageVermegFinalApplication;
...
@Builder
@NoArgsConstructor
public class BalanceTopicAggregation implements AggregationLogicTopic {
